...
var KTTablesWidget4 = function () {
    ...
    // Populate templates with content/data -- content/data can be replaced with relevant data from database or API
    const populateTemplate = (data, target) => {
        data.forEach((d, index) => {
            // Clone templates node
            ...
            // New templates border controller
            ...
            // Insert new templates into table
...
var KTTimelineWidget1 = function () {
    ...
    const initTimelineDay = () => {
        ...
        var options = {
            ...
            // Whitelist specified tags and attributes from templates --- more info: https://visjs.github.io/vis-timeline/docs/timeline/#Configuration_Options
            xss: {
                disabled: false,
                filterOptions: {
                    whiteList: {
            ...
            // specify a templates for the items
